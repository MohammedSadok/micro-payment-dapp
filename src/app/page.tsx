...
//       (transaction) =>
//         transaction.createdAt && transaction.createdAt >= startDate
//     );
//   }, [selectedPeriod]);
...
//     return filteredTransactions
//       .filter((t) => parseInt(t.amount) < 0)
//       .reduce((sum, t) => sum + Math.abs(parseInt(t.amount)), 0);
//   }, [filteredTransactions]);

//   const currentBalance = useMemo(() => {
//     return filteredTransactions.reduce((sum, t) => sum + parseInt(t.amount), 0);
//   }, [filteredTransactions]);
